...
PARAM$semillas <- c(203003, 307007, 651037, 503239, 582203)

#Crea la variable tipo lista y despues dentro de esa lista crea un campo semillas y le agrega el vector con 5 elemetnos.
